...
// BeforeAll API call ile website'e login olur ve token alır. Sonraki testlerde bu token kullanılır sadece. 
// Bu sayede login olmak için harcanan süre harcanmamış olur. 
...
test.only('@API First playwright test', async ({ page }) => {
